...
public class StockReportDTO {
	...
	public StockReportDTO(Long productId, Long variationId, String productName, String sku, String variationName,
			String variationValue, String category, String businessLocation, BigDecimal unitSellingPrice,
			BigDecimal defaultPurchasePrice, int totalPurchased, int totalSold, int totalAdjusted, int currentStock,
			BigDecimal currentStockValueByPurchase, BigDecimal currentStockValueBySale, BigDecimal potentialProfit) {
		super();
