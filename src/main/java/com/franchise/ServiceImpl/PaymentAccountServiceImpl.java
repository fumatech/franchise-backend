...
public class PaymentAccountServiceImpl implements PaymentAccountService {
    ...
    public PaymentAccount savePaymentAccount(PaymentAccount paymentAccount) {
        ...
        if (paymentAccount.getTransactions() != null && !paymentAccount.getTransactions().isEmpty()) {
            // Iterate over the transactions to ensure they are linked to the correct account
            paymentAccount.getTransactions().forEach(transaction -> transaction.setPaymentAccount(paymentAccount));

            // Calculate the balance by iterating over the transactions and adjusting the balance
            ...
            // If no transactions are provided, set the balance to the current balance of the account
    ...
    public BigDecimal getCurrentBalance(Long id) {
        ...
        // Loop through all transactions and calculate the balance based on transaction type
