...
import com.franchise.Service.AddExpensesService;
import com.franchise.Util.FileUploadUtil;

@RestController
@RequestMapping("/add-expenses")
@CrossOrigin(origins = { "http://localhost:3000", "http://localhost:3001", "http://fusionmastertech.com",
		"https://fusionmastertech.com", "http://www.fusionmastertech.com",
		"https://www.fusionmastertech.com" }, allowCredentials = "true")
